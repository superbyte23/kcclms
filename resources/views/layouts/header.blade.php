        ...
        <div class="container-xl"> 
          ...
          <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href="{{route('dashboard')}}" class="d-inline-flex align-items-center">
              <img src="{{asset('static/kcclogo.png')}}" alt="Tabler" class="navbar-brand-image avatar avatar-sm bg-transparent"> <span class="ms-2 h1 mb-0">KCC LMS</span>
            </a>
          </h1>
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                ...
                <form method="POST" id="logout-form" action="{{ route('logout') }}">
                    ...
                    <button type="submit" class="logout dropdown-item border-0">Logout</button>
                </form>
